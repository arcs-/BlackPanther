class Coin {
	...
	update() {
		if (!this.coin || !global.hero.car) return

		this.coin.rotation.y = global.clock.getElapsedTime() % 3.14 * this.z // cheap PI
		this.coin.position.y = Math.cos(global.clock.getElapsedTime() * 3) * .2 * this.z
